...
- 1.069.236 mediciones horarias de PM2.5 observadas;
- 46.752 combinaciones estación-día, 45.152 con media diaria válida (≥18
  horas) y 44.399 con `pm25_mean` y target `pm25_mean_d_plus_1` disponibles
  para el análisis supervisado;
- 37.083 mediciones horarias fuera de los límites IQR globales (-8,49;
  41,98 µg/m³).
...
- Horizonte diario: persistencia de la media diaria 2,95 µg/m³ vs. 2,73 con un
  ...
  meteorología. Es una muestra distinta de la del notebook, que reporta
  3,58 µg/m³ de MAE de persistencia sobre toda la ventana 2018–2025; los dos
