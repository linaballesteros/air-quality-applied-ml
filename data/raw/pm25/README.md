...
- Consulta comprobada: `2026-09-13`

Los archivos `.tab` se descargan localmente y están excluidos de Git. Para
obtener únicamente 2013 como muestra inicial ejecute desde la raíz:
...
de asumirlo. No editar los datos crudos.

Después de validar la muestra, el conjunto completo puede regenerarse con:
